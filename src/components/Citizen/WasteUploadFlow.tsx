...
export const WasteUploadFlow: React.FC<WasteUploadFlowProps> = ({
  onComplete,
  onCancel
}) => {
  const [step, setStep] = useState<'select' | 'camera' | 'upload' | 'preview'>('select');
  ...
  const handleSubmit = async () => {
    ...
    setUploading(true);
    try {
      await createWasteTicket(user.id, imageData);
      toast({
        title: "Waste submitted successfully!",
        description: "Your waste has been registered and will be tracked through the recycling process.",
      });
      onComplete();
    } catch (error) {
      toast({
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Make sure the image is clear and shows your waste properly
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Take a photo or upload an image of your waste for tracking
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button
              ...
              className="h-32 flex-col space-y-4 bg-primary hover:bg-primary-hover"
            >
            ...
            <div>
              ...
              <label htmlFor="file-upload" className="cursor-pointer">
                <div className="h-32 border-2 border-dashed border-border rounded-lg flex flex-col items-center justify-center space-y-4 hover:border-primary transition-colors">
                  ...
                  <div className="text-center">
                    <div className="font-semibold text-foreground">Upload Image</div>
